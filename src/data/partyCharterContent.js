export const partyCharterContent = {
    preamble: {
        title: "Preamble",
    ...
    article7: {
        ...
        sections: [
            ...
            { id: "charter-article7-section1", title: "Section 2. Oath of Loyalty", text: "All new members and officers must take an Oath of Loyalty, affirming their commitment to uphold the principles of the Party and support its mission." }
        ]
    },
    signature: {
        title: "Signature",
...
export const partyCharterPages = [
    [partyCharterContent.preamble, partyCharterContent.article1, partyCharterContent.article2], // Page 1
    [partyCharterContent.article3, partyCharterContent.article4, partyCharterContent.article5], // Page 2
    [partyCharterContent.article6, partyCharterContent.article7, partyCharterContent.signature] // Page 3
];